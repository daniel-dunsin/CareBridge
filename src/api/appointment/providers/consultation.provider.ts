...
export class ConsultationProvider {
  ...
  async createNeurologyReport(
    neurologyReportDto: NuerologyConsultationReportDto,
    appointmentId: string,
  ) {
    const appointment = await this.appointmentService.getAppointment({
      _id: appointmentId,
  ...
  async createOptometryReport(
    optometryReportDto: OptometryConsultationReportDto,
    appointmentId: string,
  ) {
    const appointment = await this.appointmentService.getAppointment({
      _id: appointmentId,
  ...
  async createCardiologyReport(
    cardiologyReportDto: CardiologyConsultationReportDto,
    appointmentId: string,
  ) {
    const appointment = await this.appointmentService.getAppointment({
      _id: appointmentId,
  ...
  async createNephrologyReport(
    nephrologyReportDto: NephrologyConsultationReportDto,
    appointmentId: string,
  ) {
    const appointment = await this.appointmentService.getAppointment({
      _id: appointmentId,
  ...
  async createHepatologyReport(
    hepatologyReportDto: HepatologyConsultationReportDto,
    appointmentId: string,
  ) {
    const appointment = await this.appointmentService.getAppointment({
      _id: appointmentId,
  ...
  async createDentistryReport(
    dentistryReportDto: DentistryConsultationReportDto,
    appointmentId: string,
  ) {
    const appointment = await this.appointmentService.getAppointment({
      _id: appointmentId,
