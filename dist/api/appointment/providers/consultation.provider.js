...
let ConsultationProvider = class ConsultationProvider {
    constructor(connection, consultationService, appointmentService, mailService, diagnosisService, patientService) {
    ...
    async createConsultationReport(createConsultationDto, appointment, diagnosis) {
    ...
    async createOrthopedicReport(orthopedicReportDto, appointmentId) {
        ...
        const diagnosis = await this.diagnosisService.createDiagnosis({ ...orthopedicReportDto, patient: appointment.patient._id }, enums_1.Departments.ORTHOPEDICS);
        ...
        const response = await this.createConsultationReport(orthopedicReportDto, appointment, diagnosis);
        return response;
    }
    async createNeurologyReport(neurologyReportDto, appointmentId) {
        ...
        if (!appointment)
            throw new common_1.NotFoundException('Appointment not found');
        const diagnosis = await this.diagnosisService.createDiagnosis({ ...neurologyReportDto, patient: appointment.patient._id }, enums_1.Departments.NEUROLOGY);
        ...
        const response = await this.createConsultationReport(neurologyReportDto, appointment, diagnosis);
        return response;
    }
    async createOptometryReport(optometryReportDto, appointmentId) {
        ...
        if (!appointment)
            throw new common_1.NotFoundException('Appointment not found');
        const diagnosis = await this.diagnosisService.createDiagnosis({ ...optometryReportDto, patient: appointment.patient._id }, enums_1.Departments.OPTOMETRY);
        ...
        const response = await this.createConsultationReport(optometryReportDto, appointment, diagnosis);
        return response;
    }
    async createCardiologyReport(cardiologyReportDto, appointmentId) {
        ...
        if (!appointment)
            throw new common_1.NotFoundException('Appointment not found');
        const diagnosis = await this.diagnosisService.createDiagnosis({ ...cardiologyReportDto, patient: appointment.patient._id }, enums_1.Departments.CARDIOLOGY);
        ...
        const response = await this.createConsultationReport(cardiologyReportDto, appointment, diagnosis);
        return response;
    }
    async createNephrologyReport(nephrologyReportDto, appointmentId) {
        ...
        if (!appointment)
            throw new common_1.NotFoundException('Appointment not found');
        const diagnosis = await this.diagnosisService.createDiagnosis({ ...nephrologyReportDto, patient: appointment.patient._id }, enums_1.Departments.NEPHROLOGY);
        ...
        const response = await this.createConsultationReport(nephrologyReportDto, appointment, diagnosis);
        return response;
    }
    async createHepatologyReport(hepatologyReportDto, appointmentId) {
        ...
        if (!appointment)
            throw new common_1.NotFoundException('Appointment not found');
        const diagnosis = await this.diagnosisService.createDiagnosis({ ...hepatologyReportDto, patient: appointment.patient._id }, enums_1.Departments.HEPATOLOGY);
        ...
        const response = await this.createConsultationReport(hepatologyReportDto, appointment, diagnosis);
        return response;
    }
    async createDermatologyReport(dermatologyReportDto, appointmentId) {
        ...
        if (!appointment)
            throw new common_1.NotFoundException('Appointment not found');
        const diagnosis = await this.diagnosisService.createDiagnosis({ ...dermatologyReportDto, patient: appointment.patient._id }, enums_1.Departments.DERMATOLOGY);
        ...
        const response = await this.createConsultationReport(dermatologyReportDto, appointment, diagnosis);
        return response;
    }
    async createDentistryReport(dentistryReportDto, appointmentId) {
        ...
        if (!appointment)
            throw new common_1.NotFoundException('Appointment not found');
        const diagnosis = await this.diagnosisService.createDiagnosis({ ...dentistryReportDto, patient: appointment.patient._id }, enums_1.Departments.DENTISTRY);
        ...
        const response = await this.createConsultationReport(dentistryReportDto, appointment, diagnosis);
        return response;
    }
    async getPatientReports(department, patientId) {
        const data = await this.diagnosisService.getMultipleDiagnosis({ patient: new mongoose_2.Types.ObjectId(patientId) }, department);
        return {
            success: true,
    ...
    async getReport(reportId, department) {
        const data = await this.diagnosisService.getSingleDiagnosis({ _id: new mongoose_2.Types.ObjectId(reportId) }, department);
        if (!data)
    ...
    async getAppoinmentReport(appointmentId) {
        ...
        if (!consultation)
            throw new common_1.NotFoundException("Opps! We can't find the consultation for this report");
