...
async function bootstrap() {
  ...
  app.useGlobalFilters(
    new global_filter_1.GlobalExceptionFilter(httpAdapterHost),
  );
  ...
  const authGuard = app
    .select(auth_module_1.AuthModule)
    .get(auth_guard_1.AuthGuard);
  ...
  swagger_1.SwaggerModule.setup('/v1/docs', app, swaggerDoc, {
