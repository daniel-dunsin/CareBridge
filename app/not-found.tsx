    ...
    <main className="grid min-h-full place-items-center px-6 py-24 sm:py-32 lg:px-8">
      <div className="text-center">
        ...
        <div className="space-y-1">
          <h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-900 dark:text-offWhite sm:text-5xl">
            Page not found
          </h1>
          <p className="mt-6 text-center max-w-md leading-[1.7] text-gray-500/60 dark:text-offWhite">
